...
import { Pressable, Text, View, Button, TouchableOpacity, Linking, Platform, Dimensions, Image } from 'react-native';
      ...
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'row' , padding: 20}}>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', justifyContent: 'space-between'}}>
            <TouchableOpacity style={{ backgroundColor: '#C3B1E1', borderRadius: 5, padding: 8}} onPress={() => Linking.openURL(pdfURL)} >
            <Text style={{ color: 'black', fontWeight: 'bold' }}>PDF</Text>
            </TouchableOpacity>
          </View>
         </View>
    ...
    <View style={styles.container}>
      ...
      <Pressable style={{marginTop:12}}>
        <TouchableOpacity style={styles.exitButton} onPress={handleExit}>
          <Text style={{alignItems: "center", paddingHorizontal: "20%",}}>Exit the Assessment</Text>
          </TouchableOpacity>
        <View style={{ flexDirection: 'row' , alignItems: 'center', justifyContent: 'space-between'}}>
          <Text style={[styles.text,{fontSize: 21, fontWeight: 'bold', alignItems: 'center'}]}>Self Assessment for Tech-Abuse</Text>
        </View>
        ...
        <Text style={[styles.text,{fontSize: 18, fontWeight: 'bold'}]}>{currentQuestion.text}</Text>
